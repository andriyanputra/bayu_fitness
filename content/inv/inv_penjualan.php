    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" action="index?fold=inv&page=inv_jual_form" method="post">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                Untuk melakukan transaksi penjualan barang, silahkan tentukan tanggal penjualan barang.
                            </div>
                        </div>
                        <br>
                        <div class="row">
