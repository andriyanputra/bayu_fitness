    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header">
                <h3 class="box-title text-center">Daftar Penjualan Barang</h3>
            </div><!-- /.box-header -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table id="data_pembelian" class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <?php
                                $view = oci_parse($koneksi, "SELECT TRANSAKSI.ID_TRANSAKSI, BARANG.ID_BARANG, BARANG.NM_BARANG, TRANSAKSI.JML_TRANSAKSI, BARANG.HARGA_BARANG, TRANSAKSI.KET_TRANSAKSI, TRANSAKSI.TGL_TRANSAKSI FROM BARANG, TRANSAKSI WHERE BARANG.ID_BARANG = TRANSAKSI.ID_BARANG AND STATUS_TRANSAKSI = 'K'");
                                oci_execute($view);
                                $no = 0;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:confirmDelete('index?fold=inv&page=inv_jual_hapus&id=<?php echo $data[ID_TRANSAKSI]; ?>')" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php
                                }
