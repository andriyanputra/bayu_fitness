<?php
    ...
    if($_SESSION[ID_LEVEL]==1) {
        $cek = oci_parse($koneksi, "SELECT ID_MEMBER, JK_KELAMIN, NM_MEMBER, ASK_MEMBER, TELP_MEMBER, ALAMAT_MEMBER, AKTIF_MEMBER, nonaktif_member-current_date as selisih, FOTO_MEMBER FROM MEMBER, LEVEL_LOGIN, dual WHERE MEMBER.ID_LEVEL = LEVEL_LOGIN.ID_LEVEL AND MEMBER.ID_MEMBER = '$_GET[id]'");
        oci_execute($cek);
        ...
        $hr_n = $array_hr[date('N', $db[NONAKTIF_MEMBER])];$bln_b = $array_bln[date('n', $db[NONAKTIF_MEMBER])];
?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                ...
                                <div class="form-group">
                                    <label for="">Masa Aktif:</label><?php $selisih = $db[SELISIH]+1; if($selisih>31){ $selisih_ = $selisih-1;?>
