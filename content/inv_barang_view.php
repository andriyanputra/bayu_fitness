                        ...
                        <table id="data_supplier" class="table table-bordered table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index?page=inv_barang_edit&id=<?php echo $data[ID_BARANG]; ?>" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="javascript:confirmDelete('index?page=inv_barang_hapus&id=<?php echo $data[ID_BARANG]; ?>')" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php
                                }
